...
function Expense() {
  ...
  const handleAddIncome = async (income) => {
    ...
    try {
      ...
      toast.success("AddExpense is Loading")
  ...
  const deleteIncomeDetails = async (id) => {
    ...
    try {
      ...
      console.log(error);
      toast.error("Failed to delete the delete", error.message);
    }
  }
  ...
  useEffect(() => {
        toast.success("EXPENSE PAGE IS LOADING");
    fetchIncomeDetails();
    fetchCategoriesDetails();
  }, []);
